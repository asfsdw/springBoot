...
<body>
	...
	<div class="container">
		...
		<hr/>
		<div class="row">
			<div class="col"><input type="button" value="돌아가기" onclick="location.href='/'" class="btn btn-secondary"/></div>
			<div class="col text-end"><input type="button" value="서버파일리스트보기" onclick="location.href='/upload/uploadList'" class="btn btn-info"/></div>
		</div>
		<hr/><br/>
		...
		<br/><hr/><br/>
		<form name="multiUploadForm" method="post" action="/upload/multiUpload" enctype="multipart/form-data">
			<h4>멀티파일 업로드</h4>
			<table class="table table-bordered">
				<tr>
