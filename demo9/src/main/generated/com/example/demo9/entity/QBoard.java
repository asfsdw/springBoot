...
public class QBoard extends EntityPathBase<Board> {
    ...
    private static final long serialVersionUID = -157099836L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QBoard board = new QBoard("board");

    public final ListPath<BoardReply, QBoardReply> boardReply = this.<BoardReply, QBoardReply>createList("boardReply", BoardReply.class, QBoardReply.class, PathInits.DIRECT2);

    public final StringPath complaint = createString("complaint");
    ...
    public final StringPath openSW = createString("openSW");
